...
export interface ApiClassClass extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    stamina: Schema.Attribute.Integer;
    intelligence: Schema.Attribute.Integer;
    volition: Schema.Attribute.Integer;
...
export interface ApiEnemyEnemy extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    risk: Schema.Attribute.Enumeration<['high', 'normal', 'low']>;
    drop: Schema.Attribute.Enumeration<['high', 'normal', 'low']>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiSkillSkill extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    name: Schema.Attribute.String;
    description: Schema.Attribute.Text;
    variant: Schema.Attribute.Enumeration<['q', 'e']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'q'>;
    image: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Schema.Attribute.Required;
